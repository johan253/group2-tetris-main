...
public final class MyMovableTetrisPiece implements MovableTetrisPiece {
     ...
     */
    @Override
    public MyMovableTetrisPiece rotateCW() {
     ...
     */
    @Override
    public MyMovableTetrisPiece rotateCCW() {
        return new MyMovableTetrisPiece(myTetrisPiece,
                                      myPosition,
     ...
     */
    @Override
    public MyMovableTetrisPiece left() {
        return new MyMovableTetrisPiece(myTetrisPiece,
     ...
     */
    @Override
    public MyMovableTetrisPiece right() {
        return new MyMovableTetrisPiece(myTetrisPiece,
                                      myPosition.transform(1, 0),
                                      myRotation);
    }
     ...
     */
    @Override
    public MyMovableTetrisPiece down() {
        return new MyMovableTetrisPiece(myTetrisPiece,
     ...
     */
    @Override
    public MyMovableTetrisPiece setPosition(final Point thePosition) {
